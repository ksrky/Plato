...
testcases =
        ...
        , ("test02.plt", (`shouldReturn` ":0 = { id = \\a. \\x:a. x } : { id : {a:*}. a -> a }\n"))
        , ("test03.plt", (`shouldReturn` "Nat = \\Nat. <Zero | Succ Nat> : *\nZero = fold [Nat] Zero : Nat\nSucc = \\1:Nat. fold [Nat] (Succ 1) : Nat -> Nat\n:0 = {} : {}\n"))
        , ("test04.plt", (`shouldReturn` ":0 = { g = \\a. \\b. \\f:a -> b. \\x:a. f x } : { g : {a:*}. {b:*}. (a -> b) -> a -> b }\n"))
        , ("test05.plt", (`shouldReturn` "Bool = \\Bool. <True | False> : *\nTrue = fold [Bool] True : Bool\nFalse = fold [Bool] False : Bool\n:0 = { not = \\b:Bool. case unfold [Bool] b of {\n    True 0 -> False\n    False 0 -> True\n} } : { not : Bool -> Bool }\n"))
        , ("test06.plt", (`shouldReturn` ":0 = { f = \\a. let :0 = fix \\:0:{ h : {a:*}. a -> a , g : {a:*}. a -> a }. { h = \\c. \\y:c. y , g = \\b. \\x:b. x } in \\x:a. (:0.g a) x } : { f : {a:*}. a -> a }\n"))
        ]
